...
/**
 * Get method for date.
 * @return date Timestamp object that represents the date an associate started a task
 */
	...
	/**
	 * Set method for date.
	 * @param date Timestamp object that represents the date an associate started a task
	 */
